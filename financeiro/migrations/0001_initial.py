    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ano', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notas', to='financeiro.Ano')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='nota',
            name='itemNota',
            field=models.ManyToManyField(related_name='notas', to='financeiro.ItemNota'),
        ),
    ]
